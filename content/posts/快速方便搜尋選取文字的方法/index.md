...
description: |-
  ...
  一般來說，必須選取想搜尋的文字→按下複製→切換到瀏覽器→打開網址列→貼上想搜尋的文字→按下 Enter 送出。

  我實在太懶惰了，沒辦法忍受每次搜尋都做一遍上面的動作。過去用 Windows 時，我會用手勢軟體 WGestures 代勞，選取文字，按著右鍵鬼畫符就完成搜尋，但 Linux 沒有一個比較完善的手勢軟體，因此得尋找其他方式實現。
...
- Kando 的 GitHub 儲存庫：[https://github.com/kando-menu/kando]()
...
- 教學頁面：[https://kando.menu/input-remapper-tutorial/]()
