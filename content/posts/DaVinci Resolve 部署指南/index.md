...
draft: false
---
Blackmagic Design 旗下的 DaVinci Resolve 僅提供特定發行版支援，且無法透過發行版的套件管理器安裝，還沒提供 .rpm 或 .deb 等包裝，需要使用官方腳本進行安裝。即便成功用腳本安裝好了，也會為未來系統維護帶來困難。因此這是我在 Linux 上安裝時唯一感到頭痛的軟體。
