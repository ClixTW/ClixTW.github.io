...
除了確定這是一封詐騙郵件以外，同時也知道是愛料理洩漏了我的電子郵件地址。而且在寫這篇部落格文章的當下，愛料理都沒有在官網或社群媒體公開這件事。不管是根本沒發現，還是打算隱瞞都很糟糕。除了電子郵件地址，不知道還洩漏了會員的哪些重要資料呢。

順帶一提，這次 NextDNS 也算是有立功。如果點擊郵件中的「前往查詢」按鈕，會被擋下來無法成功連線。
![](04.avif)
