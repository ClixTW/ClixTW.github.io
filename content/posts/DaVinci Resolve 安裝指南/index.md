...
draft: false
---
Blackmagic Design 旗下的 DaVinci Resolve 是一款功能強大的影片剪輯軟體，最棒的是提供了 Linux 版本！可惜僅提供特定發行版支援，且無法透過發行版的套件管理器安裝，還沒提供 .rpm 或 .deb 等包裝，需要使用官方腳本進行安裝。即便成功用腳本安裝好，也會為未來系統維護帶來困難。因此成為我唯一在 Linux 上安裝時感到頭痛的軟體。
