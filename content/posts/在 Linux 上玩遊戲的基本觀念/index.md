...
在 Windows 玩遊戲需要做的一些調整，在 Linux 上做法可能截然不同。每件事都不難，對長期使用者來說或許是常識，但對 Linux 完全陌生的話，一項一項弄清楚需要花費不少心力。因此寫了這篇，希望能降低轉換的摩擦。
...
2. 要透過 Gamescope 遊玩時，在遊戲的 Steam 啟動選項填入：
